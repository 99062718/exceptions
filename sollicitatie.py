...
if int(antwoord) > 30:
    raise ValueError("U bent misschien wat te oud voor deze baan...")
elif int(antwoord) >= 4:
    punten += 1
...
if antwoord.lower() == "man":
    ...
    if int(antwoord) > 100:
        raise ValueError("Ooit aan een scheermesje gedacht?")
    elif int(antwoord) >= 10:
        punten += 1
...
if int(antwoord) < 60:
    raise ValueError("Misschien moet u wat meer gaan eten")
elif int(antwoord) > 90:
    punten += 1
